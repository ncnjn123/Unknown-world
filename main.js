...
function conversation() {
    const me = ["你好，请问你是？" , "你可以告诉我你的信息吗?" , "你什么时候就开始在这了？什么时候下班？" , "你在这里无聊吗" , "嗯，那我走了"]
    const maid = ["我是个女仆" , "わからない（我不明白）..." , "我不知道什么时候在这里的，我只知道我要每隔1000秒打扫console，仅此而已" , "我不知道什么是无聊..." , "再见..."]
    const theConsole = 'window.close()'
    const narrator = '突然，这座名为window的剧场突然陷入一片黑暗，没有吵闹，但剧场内的演员观众的时空都永远地停滞了...'
